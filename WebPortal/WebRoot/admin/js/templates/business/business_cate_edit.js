define(['angular'], function(angular) {
	var businessCateEdit = angular.module('businessCateEdit', []);

	businessCateEdit.controller('businessCateEditCtrl', function($scope, $rootScope, $http, $timeout, $location, $filter, $routeParams) {
